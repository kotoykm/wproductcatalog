        ...
        if reaction
            ...
            respond_to do |format|
                if @new_reaction.save!
                    format.html { redirect_to product_path(@product), notice: "#{current_user.email} has stated that it #{@new_reaction.kind} the product" }
                else
...
#En algun momento sentarme a ver bien que hace esto...